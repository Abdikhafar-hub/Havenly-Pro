          ...
          <div className="flex items-center justify-between h-20 px-8">
            ...
            <div className="flex items-center space-x-4">
              <Button variant="ghost" size="sm" className="relative text-slate-300 hover:text-white hover:bg-slate-700/50 rounded-xl">
                ...
                <span className="absolute -top-1 -right-1 w-5 h-5 bg-red-500 rounded-full text-xs flex items-center justify-center text-white font-bold">2</span>
              </Button>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="flex items-center space-x-3 text-slate-300 hover:text-white hover:bg-slate-700/50 rounded-xl">
                    <Avatar className="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600">
                      <AvatarImage src="" />
                      <AvatarFallback className="text-white font-bold">TN</AvatarFallback>
                    </Avatar>
                    <div className="hidden sm:block text-left">
                      <span className="text-sm font-semibold text-white">John Doe</span>
                      <p className="text-xs text-slate-400">Unit 101</p>
                    </div>
                ...
                <DropdownMenuContent align="end" className="w-64 bg-slate-800/95 backdrop-blur-xl border-slate-700/50 rounded-xl">
                  ...
                  <DropdownMenuItem className="text-slate-300 hover:bg-slate-700/50 rounded-lg">
